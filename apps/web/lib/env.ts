...
export const serverEnv = {
  ...
  get clerkWebhookSecret(): string | undefined {
    return process.env.CLERK_WEBHOOK_SECRET || undefined;
  },
};
...
/** True when Clerk publishable key is present (needed for multi-tenant auth). */
export function isClerkConfigured(): boolean {
  return Boolean(publicEnv.clerkPublishableKey && serverEnv.clerkSecretKey);
}
